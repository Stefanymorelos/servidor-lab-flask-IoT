"""Servidor Flask con CRUD completo sobre MariaDB (motor local en la misma EC2)."""
...
DB_CONFIG = {
    "host": "localhost",
    "user": "app_user",
    "password": "una_contrasena_fuerte",
    "database": "lab_iot",
}
...
def data():
    ...
    print(f"[{fecha:%Y-%m-%d %H:%M:%S}] Guardado en MariaDB (id={nuevo_id}) desde {ip_origen}: {mensaje}")
